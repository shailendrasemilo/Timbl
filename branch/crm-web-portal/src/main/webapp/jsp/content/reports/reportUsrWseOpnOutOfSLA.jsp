  ...
  <div class="section">
    <div class="inner_section ">
       <div class="inner_left_lead floatl  qrcLeft">
        <bean:define id="activeMenu" value="OutOfSLAOTR" />
      ...
      <div class=" floatl manageGISRight  qrcRight qrcReports">
		...
		<form action="/qrcReportAction" id="userWiseOTR" method="post">
		<div class="relative">
        <h4>User Wise Out of SLA Open Ticket Report</h4>
			<div class="clear marginleft10 inner_left_lead floatl">
              ...
              <html:text styleClass="textbox" name="reportForm" property="userName" maxlength="128"/>
              </p>
          </div>
          </div>
          <div class="floatr inner_right">
            <p class="buttonPlacement">
              <a href="javascript:void(0);" class="main_button" id="userWiseOTRSUBMIT">Search</a>
           </p>
            <br class="clear" />
          </div>
          <div style="width: 100%;">
       ...
       <logic:notEmpty name="reportForm" property="slaReportPojos">
        <table id="reportDataTable" style="width: 100%">
         <thead>
           <c:set var="HRS_4_24" value="0" /><c:set var="DAYS_1_2" value="0" /><c:set var="DAYS_2_3" value="0" />
