...
<div class="inner_section ">
	...
	<bean:define id="activeMenu" value="ticket"/>
...
<div class=" floatl manageGISRight  qrcRight">
 <div class="success_message">
		...
		<html:form action="/qrcReportAction" method="post" styleId="IDTicket">
              ...
              <strong>Sub Sub Category</strong> <span class="LmsdropdownWithoutJs"><html:select property="qrcSubSubCategoryId" name="reportForm"
                  ...
                  <html:optionsCollection property="qrcSubSubCategoryList" name="reportForm" label="qrcSubSubCategory" value="qrcSubSubCategoryId" />
					...
					<div class="floatr buttonPlacement">
						 <a href="#" class="main_button" id="IDTicketSubmit">Search</a>
					</div>
            ...
            <tr>
              <td>${ticketList.customerId}</td>
				...
				<td><bean:write name="crmRoles" property="displayEnum(qrcTicketStatus,${ticketList.ticketStatus})"/></td>
				 <td><bean:write name="crmRoles" property="displayEnum(ticketAction,${ ticketList.resolutionType })" /></td>
				...
				<td>
				<bean:write name="crmRoles" property="displayEnum(Product,${ticketList.product})" scope="session" />
				</td>
