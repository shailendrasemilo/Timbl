...
<body>
<div id="popupSection" >
<html:form action="/refund" styleId="IDRnotRealizedPopUpForm"  method="post">
 ...
 <div class="popupSection">
	...
	<div class="inner_section">
	   <div class="inner_left_lead floatl">
		     ...
		     <p  class="floatl marginleft30">
			    ...
			    <input type="hidden" id="refundId"
							...
							name="refundId"> <input type="hidden" id="IDnewStatus"
							
							name="chequeStatus" value="NRL">
							
			     <span class="LmsdropdownWithoutJs">
			     	<html:select name="financeForm" property="bouncingReason"  styleId="bouncingReason">
			             <html:option value="">Please Select</html:option>
						 <logic:notEmpty name="financeForm" property="refundRjectionList">
			            	 <html:optionsCollection name="financeForm" property="refundRjectionList" label="categoryValue" value="categoryValue"/>
	   ...
	   <div class="floatr inner_right" style="z-index: 2;">
	     <a href="#" id="RsubmitNotRealized" class="main_button"><span>Submit</span></a>
	   </div>
