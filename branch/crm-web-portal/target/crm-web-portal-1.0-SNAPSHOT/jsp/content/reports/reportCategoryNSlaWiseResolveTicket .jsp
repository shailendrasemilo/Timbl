  ...
  <div class="section">
    <div class="inner_section ">
      <div class="inner_left_lead floatl  qrcLeft">
        <bean:define id="activeMenu" value="category&sla" />
      ...
      <div class=" floatl manageGISRight  qrcRight" style="width: 1000px;">
        ...
        <h4>Category & SLA Wise Resolve Ticket Report</h4>

        <div class="relative inner_left_lead">
       <form action="/qrcReportAction" id="IDCatNSlaResolve" method="post">
          ...
          <div class="floatr inner_right">
            <p class="buttonPlacement">
              <a href="#" class="main_button" id="IDCatNSlaResolveSubmit">Search</a>
            </p>
          </div>
          <br class="clear" />
          </form>
