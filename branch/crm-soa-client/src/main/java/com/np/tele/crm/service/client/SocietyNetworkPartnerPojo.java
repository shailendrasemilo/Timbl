...
/**
 * <p>Java class for societyNetworkPartnerPojo complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="societyNetworkPartnerPojo">
 *   &lt;complexContent>
...
@XmlType(name = "societyNetworkPartnerPojo", propOrder = {
    "createdBy",
    "createdTime",
    "displayCreatedTime",
...
public class SocietyNetworkPartnerPojo {
    ...
    {
        return "SocietyNetworkPartnerPojo [createdBy=" + createdBy + ", createdTime=" + createdTime
                + ", displayCreatedTime=" + displayCreatedTime + ", displayLastModifiedTime=" + displayLastModifiedTime
                + ", id=" + id + ", lastModifiedBy=" + lastModifiedBy + ", lastModifiedTime=" + lastModifiedTime
                + ", partnerId=" + partnerId + ", productName=" + productName + ", rfsDus=" + rfsDus + ", societyId="
                + societyId + ", status=" + status + "]";
    }
