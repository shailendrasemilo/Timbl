 ...
 *       &lt;sequence>
 *         &lt;element name="CBEL" type="{http://schemas.datacontract.org/2004/07/}clsDisableWalledGarden" minOccurs="0"/>
...
@XmlRootElement(name = "DisableWalledGarden")
public class DisableWalledGarden {

    @XmlElementRef(name = "CBEL", namespace = "h8SSRMS", type = JAXBElement.class)
    protected JAXBElement<ClsDisableWalledGarden> cbel;
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link ClsDisableWalledGarden }{@code >}
     *     
     */
    public JAXBElement<ClsDisableWalledGarden> getCBEL() {
        return cbel;
    }
     ...
     *     
     */
    public void setCBEL(JAXBElement<ClsDisableWalledGarden> value) {
        this.cbel = ((JAXBElement<ClsDisableWalledGarden> ) value);
    }
