 ...
 *       &lt;sequence>
 *         &lt;element name="CBEL" type="{http://schemas.datacontract.org/2004/07/}clsP2PReBarring" minOccurs="0"/>
...
@XmlRootElement(name = "P2PReBarring")
public class P2PReBarring {

    @XmlElementRef(name = "CBEL", namespace = "h8SSRMS", type = JAXBElement.class)
    protected JAXBElement<ClsP2PReBarring> cbel;
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link ClsP2PReBarring }{@code >}
     *     
     */
    public JAXBElement<ClsP2PReBarring> getCBEL() {
        return cbel;
    }
     ...
     *     
     */
    public void setCBEL(JAXBElement<ClsP2PReBarring> value) {
        this.cbel = ((JAXBElement<ClsP2PReBarring> ) value);
    }
