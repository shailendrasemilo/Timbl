 ...
 *       &lt;sequence>
 *         &lt;element name="CBEL" type="{http://schemas.datacontract.org/2004/07/}clsCustomerBaringExceptionList" minOccurs="0"/>
...
@XmlRootElement(name = "CustomerBaringExceptionList")
public class CustomerBaringExceptionList {

    @XmlElementRef(name = "CBEL", namespace = "h8SSRMS", type = JAXBElement.class)
    protected JAXBElement<ClsCustomerBaringExceptionList> cbel;
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link ClsCustomerBaringExceptionList }{@code >}
     *     
     */
    public JAXBElement<ClsCustomerBaringExceptionList> getCBEL() {
        return cbel;
    }
     ...
     *     
     */
    public void setCBEL(JAXBElement<ClsCustomerBaringExceptionList> value) {
        this.cbel = ((JAXBElement<ClsCustomerBaringExceptionList> ) value);
    }
