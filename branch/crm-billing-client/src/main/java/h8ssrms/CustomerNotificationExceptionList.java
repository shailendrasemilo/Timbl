 ...
 *       &lt;sequence>
 *         &lt;element name="CBEL" type="{http://schemas.datacontract.org/2004/07/}clsCustomerNotificationExceptionList" minOccurs="0"/>
...
@XmlRootElement(name = "CustomerNotificationExceptionList")
public class CustomerNotificationExceptionList {

    @XmlElementRef(name = "CBEL", namespace = "h8SSRMS", type = JAXBElement.class)
    protected JAXBElement<ClsCustomerNotificationExceptionList> cbel;
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link ClsCustomerNotificationExceptionList }{@code >}
     *     
     */
    public JAXBElement<ClsCustomerNotificationExceptionList> getCBEL() {
        return cbel;
    }
     ...
     *     
     */
    public void setCBEL(JAXBElement<ClsCustomerNotificationExceptionList> value) {
        this.cbel = ((JAXBElement<ClsCustomerNotificationExceptionList> ) value);
    }
