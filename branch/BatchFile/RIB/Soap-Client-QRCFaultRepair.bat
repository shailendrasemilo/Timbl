...
@set WSDL=http://%IPADDR%/crm-external-trigger/QRCFaultRepairService?wsdl
...
@cd %OLDDIR%
@echo CurrentDir=%CD%
@echo URL=" + PropertyUtils.getServiceDetails( IAppConstants.CRM_QRC_FAULT_REPAIR_CLIENT )+ "
pause
